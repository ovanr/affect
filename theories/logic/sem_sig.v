...
Notation "¡_[ m ] σ" := (sem_sig_flip_mbang m σ) (at level 10) : sem_sig_scope.
...
Class OnceS {Σ} (σ : sem_sig Σ) := {
  flip_mbang_elim : (⊢ (¡_[ OS ] σ) ≤S σ)
}.

Global Instance sig_fbang_once_sig {Σ} (σ : sem_sig Σ) : OnceS (¡_[ OS ] σ)%S.
