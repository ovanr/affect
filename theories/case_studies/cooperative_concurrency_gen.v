...
Section typing.
  ...
  Proof.
    ...
    iApply sem_typed_Tclosure; first solve_copy. iIntros (α).
    iApply sem_typed_closure; solve_sidecond. simpl. rewrite {2} /coop.
  ...
  Proof.
    ...
    iApply sem_typed_Rclosure; solve_copy. iIntros (θ').
    iApply sem_typed_closure; solve_sidecond. simpl.
